  ...
  POTENZA.countdownTimer = function () {
    if ($countdownTimer.exists()) {
      $countdownTimer.downCount({
        date: "5/31/2024 12:00:00", // Month/Date/Year HH:MM:SS
        offset: -4,
      });
    }
  };
...
*************************/
  ...
  *************************/
  ...
  /*************************
    Gsap
  *************************/
  gsap.set(".event-wrapper img.event-img", { yPercent: -50, xPercent: -50 });
  let activeImage;
  gsap.utils.toArray(".event-wrapper").forEach((el) => {
    let image = el.querySelector("img.event-img"),
      setX,
      setY,
      align = (e) => {
        setX(e.clientX);
